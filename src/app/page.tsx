  ...
  return (
    <div className="bg-neutral-950 min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-neutral-950/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-2 sm:py-3 md:py-4">
      ...
      <section className="w-full bg-neutral-950 py-12 sm:py-16 lg:py-24 px-8 sm:px-12 lg:px-16">
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center gap-y-12 md:gap-y-16">
          ...
          <div className="w-full max-w-5xl mx-auto px-2 sm:px-4 flex justify-center">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 justify-items-center place-items-center">
                    ...
                    <div className="flex space-x-1 md:space-x-2 justify-start">
                      {['S', 'M', 'L', 'XL'].map((size) => (
                        <button
                          ...
                          className={`w-7 h-7 md:w-8 md:h-8 rounded-lg border transition-colors ${
